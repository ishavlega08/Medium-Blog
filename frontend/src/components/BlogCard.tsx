...
export const BlogCard = ({
    ...
    return <div className="p-4 border-b-2 pb-4 border-slate-200">
        <div className="flex">
...
export function Avatar({ name, size = "small" }: { name: string, size: "small" | "big" }) {
    return <div className={`relative inline-flex items-center justify-center overflow-hidden bg-gray-600 rounded-full ${size == "small" ? "w-6 h-6" : "w-7 h-7"}`}>
